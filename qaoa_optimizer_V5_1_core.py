#!/usr/bin/env python3
"""
QAOA Optimizer Core - Version 5.1.

V5.1 keeps the V5 optimizer improvements, and fixes a layerwise warm-start
regression that still showed up on the small workbook.
...
All other behaviour is preserved. The class is exposed as ``QAOAOptimizerV51``
and aliased as ``QAOAOptimizerV5`` / ``QAOAOptimizerV4`` / ``QAOAOptimizerV3``
...
class QAOAOptimizerV51:
    """Application-friendly wrapper around the Version 5.1 notebook logic."""
    ...
    def build_qubo(self):
        self._ensure_not_stopped()
        self._log("Building Version 5.1 QUBO problem...")
    ...
    def run_classical_search(self):
        ...
        self._log("Running Version 5.1 classical heuristic...")
    ...
    def run_qaoa(self):
        ...
        self._log(f"Running Version 5.1 QAOA (p={self.qaoa_p})...")
    ...
    def generate_results(self):
        self._ensure_not_stopped()
        self._log("Generating Version 5.1 result tables...")
    ...
    def write_results(self):
        self._ensure_not_stopped()
        self._log("Writing Version 5.1 results back to Excel...")
...
# V5.1: class is now QAOAOptimizerV51. Keep V5/V4/V3 aliases so external
# callers and older scripts continue to work. Importing under any of these
# names within this module picks up the V5.1 fixes automatically.
QAOAOptimizerV5 = QAOAOptimizerV51
QAOAOptimizerV4 = QAOAOptimizerV51
QAOAOptimizerV3 = QAOAOptimizerV51
