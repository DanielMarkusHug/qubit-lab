#!/usr/bin/env python3
"""Tkinter GUI for the Version 6.0 QAOA optimizer.

V6 keeps the workbook layout intact and adds one optional Assets-sheet role
...
from qaoa_optimizer_V6_core import OptimizationCancelled, OptimizationError, QAOAOptimizerV6


class OptimizerGUIV6:
    ...
    def _setup_ui(self):
        ...
        ttk.Label(
            header_frame,
            text="Version 6.0 adds fixed/variable asset roles so existing holdings stay in the portfolio while only variable blocks consume qubits",
    ...
    def _load_workbook_settings_into_fields(self):
        ...
        set_bool(self.qaoa_concentration_polish_enabled_var, "qaoa_concentration_polish_enabled", False)
    ...
    def _write_gui_settings_to_workbook(self, xlsx_path: str):
        ...
        updates = {
            ...
            "qaoa_concentration_polish_enabled": int(self.qaoa_concentration_polish_enabled_var.get()),
...
# V6: keep the older GUI aliases importable so launcher scripts continue
# to work unchanged.
OptimizerGUIV53 = OptimizerGUIV6
OptimizerGUIV52 = OptimizerGUIV6
OptimizerGUIV51 = OptimizerGUIV6
OptimizerGUIV5 = OptimizerGUIV6


def main():
    root = tk.Tk()
    app = OptimizerGUIV6(root)
    root.mainloop()
    return app
