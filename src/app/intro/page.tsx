    ...
    <main className="relative min-h-screen text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-24">
        ...
        <p className="text-gray-200 text-xl font-semibold leading-relaxed mb-10">
          ...
          We begin with the motivation: why quantum matters at all. Then we
          explain how qubits, superposition, and entanglement work, and how they
          differ from classical bits. Finally, we build and run the first simple
          circuits together in Python.
        </p>
        <VideoList
