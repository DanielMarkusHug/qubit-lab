...
import LatestQuantumVideos from '../../components/LatestQuantumVideos';
...
We revisit vectors and matrices from high school, uncover why quantum gates must be reversible, and explore key players like the X gate and Hadamard gate — with real Python examples to prove it.
Understanding these simple tools is your gateway to mastering real quantum algorithms!</p>
          </div>
        </div>
      </section>
      ...
      <main className="max-w-6xl mx-auto px-6 pb-20 grid gap-10 md:grid-cols-2 relative z-10">
        ...
        {/* YouTube Card */}
        <div className="rounded-2xl p-8 shadow-2xl bg-blue-200 flex flex-col items-center text-center hover:scale-105 transition">
          ...
          <p className="text-gray-900 mb-6">All the videos...</p>
          <a
        ...
        <div className="rounded-2xl p-8 shadow-2xl bg-blue-200 flex flex-col items-center text-center hover:scale-105 transition">
          ...
          <p className="text-gray-900 mb-6">Let's get connected.</p>
          <a
        ...
        <div className="rounded-2xl p-8 shadow-2xl bg-blue-200 flex flex-col items-center text-center hover:scale-105 transition">
          ...
          <h2 className="text-2xl font-bold mb-2 text-gray-900">HiHello Page</h2>
          <p className="text-gray-900 mb-6">Find all my links and contact information in one place.</p>
          <a
        ...
        <div className="rounded-2xl p-8 shadow-2xl bg-blue-200 flex flex-col items-center text-center hover:scale-105 transition">
          ...
          <p className="text-gray-900 mb-6">Coming soon: all the jupyter notebooks used in the videos</p>
      ...
      {/* Latest Quantum Videos Section */}
      <section className="max-w-6xl mx-auto px-6 pb-20 relative z-10">
        <h2 className="text-3xl font-bold text-center text-gray-900 my-10">Latest Quantum Computing Videos</h2>
        <LatestQuantumVideos />
      </section>
